...
func main() {
	...
	sqlFiles := []string{
		// database
		"scripts/settings.sql",

		// tables
		"scripts/tables/USER.sql",
		"scripts/tables/DECK.sql",
		"scripts/tables/CARD.sql",
		"scripts/tables/LOBBY.sql",
		"scripts/tables/DRAW_PILE.sql",
		"scripts/tables/PLAYER.sql",
		"scripts/tables/JUDGE.sql",
		"scripts/tables/HAND.sql",
		"scripts/tables/RESPONSE.sql",
		"scripts/tables/RESPONSE_CARD.sql",
		"scripts/tables/WIN.sql",
		"scripts/tables/KICK.sql",
		"scripts/tables/USER_ACCESS_DECK.sql",
		"scripts/tables/USER_ACCESS_LOBBY.sql",
		"scripts/tables/LOGIN_ATTEMPT.sql",
		"scripts/tables/LOG_CREDITS_SPENT.sql",
		"scripts/tables/LOG_DISCARD.sql",
		"scripts/tables/LOG_SKIP.sql",
		"scripts/tables/LOG_RESPONSE_CARD.sql",
		"scripts/tables/LOG_WIN.sql",
		"scripts/tables/LOG_KICK.sql",
		"scripts/tables/AUDIT_CARD.sql",
		"scripts/tables/AUDIT_DECK.sql",
		"scripts/tables/AUDIT_USER.sql",

		// functions
		"scripts/functions/FN_GET_DRAW_PILE_CARD_ID.sql",
		"scripts/functions/FN_GET_LOBBY_JUDGE_PLAYER_ID.sql",
		"scripts/functions/FN_GET_LOGIN_ATTEMPT_IS_ALLOWED.sql",
		"scripts/functions/FN_GET_PLAYER_IS_WINNING.sql",
		"scripts/functions/FN_USER_HAS_DECK_ACCESS.sql",
		"scripts/functions/FN_USER_HAS_LOBBY_ACCESS.sql",

		// procedures
		"scripts/procedures/SP_ADD_EXTRA_RESPONSE.sql",
		"scripts/procedures/SP_ADD_EXTRA_RESPONSE_UNDO.sql",
		"scripts/procedures/SP_ALERT_LOBBY.sql",
		"scripts/procedures/SP_BET_ON_WIN.sql",
		"scripts/procedures/SP_BET_ON_WIN_UNDO.sql",
		"scripts/procedures/SP_DISCARD_CARD.sql",
		"scripts/procedures/SP_DRAW_HAND.sql",
		"scripts/procedures/SP_GAMBLE_CREDITS.sql",
		"scripts/procedures/SP_GET_READABLE_DECKS.sql",
		"scripts/procedures/SP_PICK_RANDOM_WINNER.sql",
		"scripts/procedures/SP_PICK_WINNER.sql",
		"scripts/procedures/SP_PURCHASE_CREDITS.sql",
		"scripts/procedures/SP_RESPOND_WITH_CARD.sql",
		"scripts/procedures/SP_RESPOND_WITH_FIND_CARD.sql",
		"scripts/procedures/SP_RESPOND_WITH_STEAL_CARD.sql",
		"scripts/procedures/SP_RESPOND_WITH_SURPRISE_CARD.sql",
		"scripts/procedures/SP_RESPOND_WITH_WILD_CARD.sql",
		"scripts/procedures/SP_SET_LOSING_STREAK.sql",
		"scripts/procedures/SP_SET_MISSING_JUDGE_CARD.sql",
		"scripts/procedures/SP_SET_MISSING_JUDGE_PLAYER.sql",
		"scripts/procedures/SP_SET_NEXT_JUDGE_CARD.sql",
		"scripts/procedures/SP_SET_NEXT_JUDGE_PLAYER.sql",
		"scripts/procedures/SP_SET_PLAYER_ACTIVE.sql",
		"scripts/procedures/SP_SET_PLAYER_INACTIVE.sql",
		"scripts/procedures/SP_SET_RESPONSE_COUNT.sql",
		"scripts/procedures/SP_SET_RESPONSES_LOBBY.sql",
		"scripts/procedures/SP_SET_RESPONSES_PLAYER.sql",
		"scripts/procedures/SP_SET_WINNING_STREAK.sql",
		"scripts/procedures/SP_SKIP_JUDGE.sql",
		"scripts/procedures/SP_SKIP_PROMPT.sql",
		"scripts/procedures/SP_START_NEW_ROUND.sql",
		"scripts/procedures/SP_VOTE_TO_KICK.sql",
		"scripts/procedures/SP_VOTE_TO_KICK_UNDO.sql",
		"scripts/procedures/SP_WITHDRAW_CARD.sql",
		"scripts/procedures/SP_WITHDRAW_LOBBY.sql",
		"scripts/procedures/SP_WITHDRAW_RESPONSE.sql",

		// events
		"scripts/events/EVT_CLEAN_BAD_PROMPT_CARDS.sql",
		"scripts/events/EVT_CLEAN_BAD_RESPONSE_CARDS.sql",
		"scripts/events/EVT_CLEAN_LOGIN_ATTEMPTS.sql",

		// triggers
		"scripts/triggers/TR_AUDIT_CARD_DELETE.sql",
		"scripts/triggers/TR_AUDIT_CARD_UPDATE.sql",
		"scripts/triggers/TR_AUDIT_DECK_DELETE.sql",
		"scripts/triggers/TR_AUDIT_DECK_UPDATE.sql",
		"scripts/triggers/TR_AUDIT_USER_DELETE.sql",
		"scripts/triggers/TR_AUDIT_USER_UPDATE.sql",
		"scripts/triggers/TR_LOBBY_AFTER_DELETE.sql",
		"scripts/triggers/TR_LOBBY_AFTER_INSERT.sql",
		"scripts/triggers/TR_LOBBY_AFTER_UPDATE.sql",
		"scripts/triggers/TR_PLAYER_AFTER_INSERT.sql",
		"scripts/triggers/TR_PLAYER_AFTER_UPDATE.sql",
		"scripts/triggers/TR_PLAYER_BEFORE_INSERT.sql",
		"scripts/triggers/TR_REVOKE_ACCESS_AF_UP_DECK.sql",
		"scripts/triggers/TR_REVOKE_ACCESS_AF_UP_LOBBY.sql",
		"scripts/triggers/TR_SET_CHANGED_ON_DATE_BF_UP_CARD.sql",
		"scripts/triggers/TR_SET_CHANGED_ON_DATE_BF_UP_DECK.sql",
		"scripts/triggers/TR_SET_CHANGED_ON_DATE_BF_UP_USER.sql",
	}
