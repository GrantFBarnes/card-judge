...
func main() {
	...
	sqlFiles := []string{
		// database
		"database/scripts/settings.sql",

		// tables
		"database/scripts/tables/USER.sql",
		"database/scripts/tables/DECK.sql",
		"database/scripts/tables/CARD.sql",
		"database/scripts/tables/LOBBY.sql",
		"database/scripts/tables/DRAW_PILE.sql",
		"database/scripts/tables/PLAYER.sql",
		"database/scripts/tables/JUDGE.sql",
		"database/scripts/tables/HAND.sql",
		"database/scripts/tables/RESPONSE.sql",
		"database/scripts/tables/RESPONSE_CARD.sql",
		"database/scripts/tables/WIN.sql",
		"database/scripts/tables/KICK.sql",
		"database/scripts/tables/USER_ACCESS_DECK.sql",
		"database/scripts/tables/USER_ACCESS_LOBBY.sql",
		"database/scripts/tables/LOGIN_ATTEMPT.sql",
		"database/scripts/tables/LOG_CREDITS_SPENT.sql",
		"database/scripts/tables/LOG_DISCARD.sql",
		"database/scripts/tables/LOG_SKIP.sql",
		"database/scripts/tables/LOG_RESPONSE_CARD.sql",
		"database/scripts/tables/LOG_WIN.sql",
		"database/scripts/tables/LOG_KICK.sql",
		"database/scripts/tables/AUDIT_CARD.sql",
		"database/scripts/tables/AUDIT_DECK.sql",
		"database/scripts/tables/AUDIT_USER.sql",

		// functions
		"database/scripts/functions/FN_GET_DRAW_PILE_CARD_ID.sql",
		"database/scripts/functions/FN_GET_LOBBY_JUDGE_PLAYER_ID.sql",
		"database/scripts/functions/FN_GET_LOGIN_ATTEMPT_IS_ALLOWED.sql",
		"database/scripts/functions/FN_GET_PLAYER_IS_WINNING.sql",
		"database/scripts/functions/FN_USER_HAS_DECK_ACCESS.sql",
		"database/scripts/functions/FN_USER_HAS_LOBBY_ACCESS.sql",

		// procedures
		"database/scripts/procedures/SP_ADD_EXTRA_RESPONSE.sql",
		"database/scripts/procedures/SP_ADD_EXTRA_RESPONSE_UNDO.sql",
		"database/scripts/procedures/SP_ALERT_LOBBY.sql",
		"database/scripts/procedures/SP_BET_ON_WIN.sql",
		"database/scripts/procedures/SP_BET_ON_WIN_UNDO.sql",
		"database/scripts/procedures/SP_DISCARD_CARD.sql",
		"database/scripts/procedures/SP_DRAW_HAND.sql",
		"database/scripts/procedures/SP_GAMBLE_CREDITS.sql",
		"database/scripts/procedures/SP_GET_READABLE_DECKS.sql",
		"database/scripts/procedures/SP_PICK_RANDOM_WINNER.sql",
		"database/scripts/procedures/SP_PICK_WINNER.sql",
		"database/scripts/procedures/SP_PURCHASE_CREDITS.sql",
		"database/scripts/procedures/SP_RESPOND_WITH_CARD.sql",
		"database/scripts/procedures/SP_RESPOND_WITH_FIND_CARD.sql",
		"database/scripts/procedures/SP_RESPOND_WITH_STEAL_CARD.sql",
		"database/scripts/procedures/SP_RESPOND_WITH_SURPRISE_CARD.sql",
		"database/scripts/procedures/SP_RESPOND_WITH_WILD_CARD.sql",
		"database/scripts/procedures/SP_SET_LOSING_STREAK.sql",
		"database/scripts/procedures/SP_SET_MISSING_JUDGE_CARD.sql",
		"database/scripts/procedures/SP_SET_MISSING_JUDGE_PLAYER.sql",
		"database/scripts/procedures/SP_SET_NEXT_JUDGE_CARD.sql",
		"database/scripts/procedures/SP_SET_NEXT_JUDGE_PLAYER.sql",
		"database/scripts/procedures/SP_SET_PLAYER_ACTIVE.sql",
		"database/scripts/procedures/SP_SET_PLAYER_INACTIVE.sql",
		"database/scripts/procedures/SP_SET_RESPONSE_COUNT.sql",
		"database/scripts/procedures/SP_SET_RESPONSES_LOBBY.sql",
		"database/scripts/procedures/SP_SET_RESPONSES_PLAYER.sql",
		"database/scripts/procedures/SP_SET_WINNING_STREAK.sql",
		"database/scripts/procedures/SP_SKIP_JUDGE.sql",
		"database/scripts/procedures/SP_SKIP_PROMPT.sql",
		"database/scripts/procedures/SP_START_NEW_ROUND.sql",
		"database/scripts/procedures/SP_VOTE_TO_KICK.sql",
		"database/scripts/procedures/SP_VOTE_TO_KICK_UNDO.sql",
		"database/scripts/procedures/SP_WITHDRAW_CARD.sql",
		"database/scripts/procedures/SP_WITHDRAW_LOBBY.sql",
		"database/scripts/procedures/SP_WITHDRAW_RESPONSE.sql",

		// events
		"database/scripts/events/EVT_CLEAN_BAD_PROMPT_CARDS.sql",
		"database/scripts/events/EVT_CLEAN_BAD_RESPONSE_CARDS.sql",
		"database/scripts/events/EVT_CLEAN_LOGIN_ATTEMPTS.sql",

		// triggers
		"database/scripts/triggers/TR_AUDIT_CARD_DELETE.sql",
		"database/scripts/triggers/TR_AUDIT_CARD_UPDATE.sql",
		"database/scripts/triggers/TR_AUDIT_DECK_DELETE.sql",
		"database/scripts/triggers/TR_AUDIT_DECK_UPDATE.sql",
		"database/scripts/triggers/TR_AUDIT_USER_DELETE.sql",
		"database/scripts/triggers/TR_AUDIT_USER_UPDATE.sql",
		"database/scripts/triggers/TR_LOBBY_AFTER_DELETE.sql",
		"database/scripts/triggers/TR_LOBBY_AFTER_INSERT.sql",
		"database/scripts/triggers/TR_LOBBY_AFTER_UPDATE.sql",
		"database/scripts/triggers/TR_PLAYER_AFTER_INSERT.sql",
		"database/scripts/triggers/TR_PLAYER_AFTER_UPDATE.sql",
		"database/scripts/triggers/TR_PLAYER_BEFORE_INSERT.sql",
		"database/scripts/triggers/TR_REVOKE_ACCESS_AF_UP_DECK.sql",
		"database/scripts/triggers/TR_REVOKE_ACCESS_AF_UP_LOBBY.sql",
		"database/scripts/triggers/TR_SET_CHANGED_ON_DATE_BF_UP_CARD.sql",
		"database/scripts/triggers/TR_SET_CHANGED_ON_DATE_BF_UP_DECK.sql",
		"database/scripts/triggers/TR_SET_CHANGED_ON_DATE_BF_UP_USER.sql",
	}
