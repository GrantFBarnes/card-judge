...
func main() {
	...
	http.Handle("GET /stats/personal", api.MiddlewareForPages(http.HandlerFunc(apiPages.StatsPersonal)))
	http.Handle("GET /stats/global", api.MiddlewareForPages(http.HandlerFunc(apiPages.StatsGlobal)))
