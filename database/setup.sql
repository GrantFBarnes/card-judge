...
(
    ...
    SURPRISE_CARDS_REMAINING INT NOT NULL,
...
BEGIN
    ...
    SELECT SURPRISE_CARD_LIMIT
    INTO VAR_SURPRISE_CARD_LIMIT
    FROM LOBBY
    WHERE ID = VAR_LOBBY_ID;
	
    INSERT IGNORE INTO PLAYER (ID, LOBBY_ID, USER_ID, SURPRISE_CARDS_REMAINING)
    VALUES (VAR_PLAYER_ID, VAR_LOBBY_ID, VAR_USER_ID, VAR_SURPRISE_CARD_LIMIT);
