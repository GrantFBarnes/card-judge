...
(
    ...
    SPECIAL_CARD_LIMIT INT NOT NULL DEFAULT -1,
...
BEGIN
    ...
    ELSE
        ...
        WHERE D.ID <> '00000000-0000-0000-0000-000000000000'
            AND (
                    UAD.USER_ID = VAR_USER_ID OR
                    (D.IS_PUBLIC_READONLY AND VAR_READONLY)
                )
        ORDER BY D.NAME ASC;
    END IF;
END;
...
BEGIN
    ...
    UPDATE PLAYER
    SET SPECIAL_CARDS_PLAYED = SPECIAL_CARDS_PLAYED + 1
    WHERE ID = VAR_PLAYER_ID;

    INSERT INTO LOG_DRAW (PLAYER_USER_ID, CARD_ID, IS_SURPRISE)
    VALUES (VAR_PLAYER_USER_ID, VAR_CARD_ID, 1);

    CALL SP_PLAY_CARD (VAR_PLAYER_ID, VAR_CARD_ID, 1, 0);
END;
//
DELIMITER ;
...
BEGIN
    ...
    VALUES (VAR_CARD_ID, '00000000-0000-0000-0000-000000000000', 'PLAYER', VAR_CARD_TEXT);

    UPDATE PLAYER
    SET SPECIAL_CARDS_PLAYED = SPECIAL_CARDS_PLAYED + 1
    WHERE ID = VAR_PLAYER_ID;

    CALL SP_PLAY_CARD (VAR_PLAYER_ID, VAR_CARD_ID, 0, 1);
END;
//
DELIMITER ;
