...
CREATE TRIGGER HAND_SET_CHANGED_ON_DATE
...
CREATE TRIGGER JUDGE_SET_CHANGED_ON_DATE
BEFORE UPDATE ON JUDGE
FOR EACH ROW
SET NEW.CHANGED_ON_DATE = CURRENT_TIMESTAMP();

DROP PROCEDURE IF EXISTS SET_JUDGE;
DELIMITER //
CREATE PROCEDURE SET_JUDGE (
...
CREATE TRIGGER PLAYER_JOINED_SET_JUDGE
AFTER INSERT ON PLAYER
FOR EACH ROW
CALL SET_JUDGE (NEW.LOBBY_ID);

CREATE TRIGGER PLAYER_LEFT_SET_JUDGE
AFTER DELETE ON PLAYER
FOR EACH ROW
CALL SET_JUDGE (OLD.LOBBY_ID);
...
CREATE TRIGGER BOARD_SET_CHANGED_ON_DATE
...
CREATE TRIGGER WIN_SET_CHANGED_ON_DATE
BEFORE UPDATE ON WIN
FOR EACH ROW
SET NEW.CHANGED_ON_DATE = CURRENT_TIMESTAMP();

DROP PROCEDURE IF EXISTS REPLACE_JUDGE;
DELIMITER //
CREATE PROCEDURE REPLACE_JUDGE (
    IN JUDGE_LOBBY_ID UUID,
...
CREATE TRIGGER WINNER_CHOSEN_REPLACE_JUDGE
AFTER INSERT ON WIN
FOR EACH ROW
CALL REPLACE_JUDGE (NEW.LOBBY_ID, NEW.PLAYER_ID);
