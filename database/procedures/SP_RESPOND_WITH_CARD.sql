...
BEGIN
    ...
    DECLARE VAR_JUDGE_RESPONSE_COUNT INT;
    ...
    SELECT BLANK_COUNT, RESPONSE_COUNT
    INTO VAR_JUDGE_BLANK_COUNT, VAR_JUDGE_RESPONSE_COUNT
    FROM JUDGE
    ...
    WHILE VAR_PLAYER_RESPONSE_COUNT < VAR_JUDGE_RESPONSE_COUNT
        DO
